(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AssistantWidget = {}, global.React));
        ...
        return (React.createElement("div", { className: "chatbot-container", style: {
            ...
            React.createElement("div", { className: "chatbot" },
                React.createElement("header", { style: { background: primaryColor } },
                    ...
                    React.createElement("span", { className: "close-btn material-symbols-outlined" }, "close")),
                ...
                React.createElement("div", { className: "chat-input" },
                    React.createElement("textarea", { ref: chatInputRef, placeholder: inputMsgPlaceholder, spellCheck: "false", required: true, value: userMessage, onChange: handleInputChange, onKeyDown: handleKeyPress, maxLength: 500, rows: 3, onFocus: handleFocus, onBlur: handleBlur }),
